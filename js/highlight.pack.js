...
illegal:"[^\\s\\}]"}}})());hljs.registerLanguage("abnf",(()=>{"use strict";return s=>({
...
begin:/%[si]/},s.QUOTE_STRING_MODE,s.NUMBER_MODE]})})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("fsharp",(()=>{"use strict";return e=>{const n={begin:"<",
...
}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
